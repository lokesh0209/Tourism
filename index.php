                     ...
                     function validate()
                    {
                       ...
                       if( document.myForm.Password.value == "" )
                      {
						 ...
						 <div class="main">
						   ...
						   <a href="register.php"><div class="register" onmouseover="this.style.background='#ff3333';"onmouseout="this.style.background='#404040';"><font color="white">Register </font></div></a>
